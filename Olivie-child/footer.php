...
<p class="footer-copy" role="contentinfo">
  <?php if ( get_option( 'ace_footer_credit' ) == true ) { echo stripslashes_deep( get_option( 'ace_footer_credit' ) ); } else { ?>&copy; <?php _e( 'Copyright','ace' ); ?> <a href="<?php echo esc_url( home_url() ); ?>" itemtype="copyrightHolder"><?php bloginfo( 'name' ); ?></a> <span itemtype="copyrightYear" content="<?php echo date( 'Y' ); ?>"><?php echo date( 'Y' ); ?></span>. <?php _e( 'Theme By','ace' ); ?> <a href="<?php echo esc_url( 'http://www.bluchic.com' ); ?>">Bluchic</a><?php } ?><br/>
  &copy; Photographs by <a href="https://www.reneejoannephotography.com/" target="_blank">Renee Joanne Photography</a>.
</p>
